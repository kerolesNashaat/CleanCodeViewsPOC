...
/**
 * In-memory [CharacterRepository] double used by instrumented tests. Emits synchronously
 * so ViewModel `init` blocks resolve their data before a fragment's observers attach,
 * removing the need for coroutine dispatcher swaps in tests.
 */
